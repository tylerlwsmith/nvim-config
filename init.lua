...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Clone the default Telescope configuration to find hidden files.
      ...
      vim.keymap.set('n', '<leader>gm', builtin.git_status, { desc = '[G]it [M]odified Files' })
